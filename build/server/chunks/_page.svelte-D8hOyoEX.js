...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="flex items-center justify-between mb-6"><h1 class="text-2xl font-bold" data-svelte-h="svelte-kwlec1">Certifications</h1> ${`<button class="btn-primary text-sm">${validate_component(Plus, "Plus").$$render($$result, { size: 16 }, {}, {})} Ajouter</button>`}</div> ${`${`<div class="flex justify-center py-20" data-svelte-h="svelte-1tend7b"><div class="animate-spin rounded-full h-10 w-10 border-4 border-primary-500 border-t-transparent"></div></div>`}`}`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-D8hOyoEX.js.map
