<script lang="ts">
  ...
  import { getProfile, getExperiences, getEducation, getSkills, getLanguages, getHobbies, getSoftwareTools, getImageUrl, isConfigured, supabase } from '$lib/api/supabase'
